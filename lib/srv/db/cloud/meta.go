...
func (m *Metadata) fetchRDSMetadata(ctx context.Context, database types.Database) (*types.AWS, error) {
	...
	if database.GetAWS().RDS.ProxyID != "" {
		return fetchRDSProxyMedata(ctx, rds, database.GetAWS().RDS.ProxyID)
	}
...
// fetchRDSProxyMedata fetches metadata about specified RDS proxy.
func fetchRDSProxyMedata(ctx context.Context, rdsClient rdsiface.RDSAPI, proxyID string) (*types.AWS, error) {
